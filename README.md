...
An automated plant watering system that monitors soil moisture using an Arduino sensor and activates a water pump when the soil becomes dry.
...
Hardware
Arduino • Moisture Sensor • Water Pump • MOSFET Driver • External Power
